...
function showNotificationPopup(data) {
    var html = createNotification(data);
    var element = $(html);
...
function getChatImageElements(chatData) {
    ...
    var chatImage = getUserChatImageElements(otherChatUsers[0]);
...
function getUserChatImageElements(user) {
...
function outputNotificationsList(notifications, container) {
    notifications.forEach((notification) => {
        var html = createNotification(notification);
        container.append(html);
    });
...
function getNotificationText(notification) {
    ...
    if (!userFrom.firstName || !userFrom.lastName) {
        return alert('userFrom data not populate');
    }
